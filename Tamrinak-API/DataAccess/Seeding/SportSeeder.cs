	...
	public static class SportSeeder
	{
		public static void SeedSports(ModelBuilder modelBuilder)
		{
			modelBuilder.Entity<Sport>().HasData(
				//TODO remove some sports
				new Sport { SportId = 1, Name = "Football", Description = "Popular team sport played with a spherical ball" }, // TODO Images C:\Users\mousa\Source\Repos\Tamrinak - Backend\Tamrinak - API\wwwroot\uploads\sports\game.png 
